class AppConstants {
  ...
  static const review1 = "بصراحة ، موقع متكامل ، ضلوا معنا من الألف الى الياء ، ما احتجت ألجأ لأي موقع تاني ، بلشنا بالتأسيس ، والشرح المفصل ، أوراق عمل ، اختبر نفسك ، امتحانات تحاكي طريقة الوزارة ، وختمنا بالمكثفات الرائعة ،";
  static const review2 = "موقع وتد رائع ، دراسة مريحة ، بتوفر الوقت والجهد ، والسعر أوفر بكتير من أي طرق تدريس تانية ، والنتائج كانت واضحة من امتحانات التجريبي ، كنت الأكثر تفوقا بصيفي ، والكل سألني عن السر ، وقلت بكل ثقة ، وتد التعليمي مع كوادره كامل متكامل ، بغنيني ، بكفي وبوفي ...";
